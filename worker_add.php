                ...
                <div class="col-md-12" >
                  ...
                  <div class="col-md-12 top-20">                  
                    ...
                    <div class="panel">
                          ...
                          <div class="col-md-2">
						    <h4> Logging</h4>
                            <input type="text" value="50" class="dial dial1" name="logging">
                          </div>
                          <div class="col-md-2">
						    <h4> Produce </h4>
                            <input type="text" value="50" class="dial dial1" name="produce">
                          </div>
                          <div class="col-md-2">
						    <h4> Retouch</h4>
                            <input type="text" value="50" class="dial dial1" name="retouch">
                          </div>
